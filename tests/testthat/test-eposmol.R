...
test_that("loadScoringTable works", {
  scoringTable <- loadScoringTable(path=file.path("..","..","inst","Table 1_mod.xlsx"))
  expect_equal(nrow(scoringTable), 609)
  expect_equal(ncol(scoringTable), 7)
})

test_that("loadCategoryAndClassMapTable works", {
  scoringTable <- loadCategoryAndClassMapTable(path=file.path("..","..","inst","class_map.xlsx"))
  expect_equal(nrow(scoringTable), 87)
})

test_that("readLongTable works", {
  scoringTable <- loadScoringTable(path=file.path("..","..","inst","Table 1_mod.xlsx"))
  tbleLong <- openxlsx::read.xlsx(file.path("..","..","inst","Table S2.xlsx"), sheet = "Long Format")
...
test_that("readWideTable works", {
  scoringTable <- loadScoringTable(path=file.path("..","..","inst","Table 1_mod.xlsx"))
  tbleWide <- openxlsx::read.xlsx(file.path("..","..","inst","Table S2.xlsx"), sheet = "Wide Format")
